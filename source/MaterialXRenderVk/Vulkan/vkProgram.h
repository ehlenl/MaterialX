...
/// @file
/// Glsl Vulkan Program interfaces
...
/// @class VkProgram
/// A class representing an executable Glsl Vulkan program.
///
...
{
  public:
    /// Create a Glsl Vulkan program instance
    static VkProgramPtr create()
    {
        return VkProgramPtr(new VkProgram());
    }
    ...
    void bindAttribute(const VkProgram::InputMap& inputs, MeshPtr mesh);
