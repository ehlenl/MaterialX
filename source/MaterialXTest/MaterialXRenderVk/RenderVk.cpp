...
void VkShaderRenderTester::createRenderer(std::ostream& log)
{
    ...
    try
    {
        _renderer = mx::VkRenderer::create();
...
void VkShaderRenderTester::runBake(mx::DocumentPtr doc, const mx::FileSearchPath& /*imageSearchPath*/, const mx::FilePath& /*outputFileName*/,
